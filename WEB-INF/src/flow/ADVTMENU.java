 ...
 */
public class ADVTMENU extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event("NINM", null, new com.avaya.sce.runtime.Goto("NEWS", 3, true));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("RECRUITMENT", "1", "exact", "RECRUITMENT", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("AUTOMOTIVE", "2", "exact", "AUTOMATIVE", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("REALESTATE", "3", "exact", "REAL", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("OBITS", "4", "exact", "OBITS", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("WEDDING", "5", "exact", "WEDDING", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("C2C", "6", "exact", "OTHERS", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("REPEAT", "9", "exact", "TWP_ADVT", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("AGENT", "0", "exact", "NEWS", grammarInfo, true);
		list.add(choice);
