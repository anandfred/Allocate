 ...
 * Last generated by Dialog Designer at: 2008-FEB-21  09:54:09 AM
 */
public class GETDNIS extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("GDDNIS");
		return submit;
	}
	/**
	...
	public java.util.Collection getPlatformObjects(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build extension object: "GETDNISOBJ"
		promptNames = new java.util.ArrayList();
		platformObject = new com.avaya.sce.runtime.PlatformObject("GETDNISOBJ", "com.avaya.subprog",
			"", "", "",
			 "", "", promptNames);
		platformObject.addParam("application_name", "twp_sap", com.avaya.sce.runtime.Parameter.CONSTANT);
		platformObject.addParam("arg2", "CALLINFO", com.avaya.sce.runtime.Parameter.CONSTANT);
		platformObject.addShadowVariable("retVal");
		platformObject.addShadowVariable("ret1");
