 ...
 */
public class Circulation_Readback extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("APPName", "xxxx", com.avaya.sce.runtime.Parameter.CONSTANT);
		list.add(param);
