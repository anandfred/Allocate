 ...
 * Last generated by Dialog Designer at: 2007-AUG-27  03:18:12 PM
 */
public class TEPDSCNT extends com.avaya.sce.runtime.Disconnect {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("tepstop", false);
		list.add(event);
		return(list);
	}
	/**
