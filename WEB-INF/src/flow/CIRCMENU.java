 ...
 */
public class CIRCMENU extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("CIRCULATION", "1", "exact", "CIRCULATION", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("MAILSUB", "2", "exact", "MAILSUB", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("OFFICEPAY", "3", "exact", "OFFICEPAY", grammarInfo, true);
		list.add(choice);
