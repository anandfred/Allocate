 ...
 */
public class MENU_C2C extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event("NINM", null, new com.avaya.sce.runtime.Goto("MENU_TRIES", 0, true));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("PAS_EMPLOYMENT_AD", "1.0"));

		choice = new com.avaya.sce.runtime.Choice("EMPLOYMENT", "1", "exact", "SET_JAUSL", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("CLASSIFIED", "2", "exact", "ADTSMNT", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("IVR", "0", "exact", "ADTSMNT", grammarInfo, true);
		list.add(choice);
