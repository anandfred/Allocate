 ...
 */
public class PRMT_EXTENSION extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2007-AUG-22  12:53:57 PM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		events.add(event);
		event = new com.avaya.sce.runtime.Event("NINM", null, new com.avaya.sce.runtime.Goto("PAS_TEP", 0, true));
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("CLCT_EXTN", false, true, grammarInfo, promptNames, events, properties, 1);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TRANSFER_EXTN");
		return submit;
	}
	/**
