 ...
 */
public class DashBoardModule extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPlatformObjects(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build extension object: "dashBoard"
		promptNames = new java.util.ArrayList();
		platformObject = new com.avaya.sce.runtime.PlatformObject("dashBoard", "com.avaya.subprog",
			"", "", "",
			 "", "", promptNames);
		platformObject.addParam("application_name", "pas_bpno", com.avaya.sce.runtime.Parameter.CONSTANT);
