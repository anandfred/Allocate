 ...
 * Last generated by Dialog Designer at: 2007-MAY-17  01:37:12 PM
 */
public class Recording_utility extends com.avaya.sce.runtime.Form {
	 ...
	 * by ghe code generator based on items in the call flow editor.
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("tep_stop");
		return submit;
	}
	/**
	...
	public java.util.Collection getPlatformObjects(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		objectList = new java.util.ArrayList(1);

		// build extension object: "recording"
		promptNames = new java.util.ArrayList();
		platformObject = new com.avaya.sce.runtime.PlatformObject("recording", "com.avaya.subprog",
			"", "", "",
			 "", "", promptNames);
		platformObject.addParam("application_name", "rec_wav", com.avaya.sce.runtime.Parameter.CONSTANT);
		platformObject.addShadowVariable("retVal");
		objectList.add(platformObject);
