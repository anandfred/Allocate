 ...
 * Last generated by Dialog Designer at: 2008-JAN-20  07:44:39 PM
 */
public class TWP_XFER extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TEPDSCNT");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		transfer = new com.avaya.sce.runtime.Transfer("TWPXFER", "EXTENSION", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "", com.avaya.sce.runtime.Transfer.CONSTANT,false);
		return transfer;
	}
	/**
