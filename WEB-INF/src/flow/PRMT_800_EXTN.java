 ...
 * Last generated by Dialog Designer at: 2008-JAN-20  09:20:51 PM
 */
public class PRMT_800_EXTN extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event("NM", null, new com.avaya.sce.runtime.Goto("TEPDSCNT", 3, true));
		list.add(event);

		event = new com.avaya.sce.runtime.Event("NI", null, new com.avaya.sce.runtime.Goto("TWP_MAIN_MENU", 0, true));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "CLCT_800_EXTN"
		promptNames = new java.util.ArrayList();
		promptNames.add("TWP_PORT_EXTN");
		...
		// build events for the field: "CLCT_800_EXTN"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, null, new com.avaya.sce.runtime.Throw("NI", 0, null));
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, null, new com.avaya.sce.runtime.Throw("NM", 0, null));
		events.add(event);

		// build properties for the field: "CLCT_800_EXTN"
		properties = new java.util.ArrayList(1);

		property = new com.avaya.sce.runtime.Property("termchar", "#");
		properties.add(property);

		field = new com.avaya.sce.runtime.Field("CLCT_800_EXTN", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SETEXTN");
		return submit;
	}
	/**
