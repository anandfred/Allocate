 ...
 * Last generated by Dialog Designer at: 2008-FEB-06  03:01:50 PM
 */
public class MENU_DISPLAY extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("RETAIL", "1", "exact", "RETAIL", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList();

		choice = new com.avaya.sce.runtime.Choice("INATIONAL", "2", "exact", "INATIONAL", grammarInfo, true);
		list.add(choice);
