 ...
 */
public class CONVRSNT_MENU extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event("NI", null, new com.avaya.sce.runtime.Goto("STAR_OR_POUND", 0, true));
		list.add(event);

		event = new com.avaya.sce.runtime.Event("NM", null, new com.avaya.sce.runtime.Goto("EXTNMENU", 0, true));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("CHOICE_*", "*", "exact", "STAR_OR_POUND", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("CHOICE_1", "1", "exact", "ONE_TO_NINE", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add("PORT_THANKYOU");
		list.add("PR_TWP_CONVRNST_MENU");
