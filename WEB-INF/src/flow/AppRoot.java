...
public class AppRoot extends com.avaya.sce.runtime.Root {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("TEPDSCNT", false);
		list.add(event);

		event = new com.avaya.sce.runtime.Event("error.badfetch", null, new com.avaya.sce.runtime.Goto("TEPDSCNT", 0, true));
		list.add(event);

		event = new com.avaya.sce.runtime.Event("error.runtime", null, new com.avaya.sce.runtime.Goto("TEPDSCNT", 0, true));
		list.add(event);
		return(list);
	}
}
